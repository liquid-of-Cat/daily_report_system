...
<input type="time" name="${AttributeConst.REP_START_TIME.getValue()}" id="${AttributeConst.REP_START_TIME.getValue()}" value="${report.startTime}" />
<br /><br />

<label for="${AttributeConst.REP_FINISH_TIME.getValue()}">退勤時間</label><br />
<input type="time" name="${AttributeConst.REP_FINISH_TIME.getValue()}" id="${AttributeConst.REP_FINISH_TIME.getValue()}" value="${report.finishTime}" />
<br /><br />
